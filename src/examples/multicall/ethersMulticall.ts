...
async function multicall() {
    ...
    const liqContract = new ethers.Contract("0x949AC43bb71F8710B0F1193880b338f0323DeB1a", liqAbi, wallet);
    ...
    const mulContract = new ethers.Contract("0x77dca2c955b15e9de4dbbcf1246b4b85b651e50e", mulAbi, wallet);
    ...
    const calls = [
        {
            target: '0x949AC43bb71F8710B0F1193880b338f0323DeB1a',
